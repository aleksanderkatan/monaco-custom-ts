define("vs/monaco.contribution-Cn24zS48", ["require", "exports", "./editor.api-CykLys8L"], (function(require, exports, editor_api) {
  "use strict";
  const typescriptVersion$1 = "5.9.11";
  ...
  function getMode() {
    return new Promise((resolve, reject) => require(["./tsMode-DEDIdClu"], resolve, reject));
  }
