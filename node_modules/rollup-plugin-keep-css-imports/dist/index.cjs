...
var assertLocation = function (outDir, assetPath) {
    if (!path__namespace.normalize(assetPath).startsWith(path__namespace.normalize(outDir))) {
...
var ensureSourceMap = function (_a, includeSourceMap, fileName, onEmit) {
    ...
    if (map) {
        if (includeSourceMap === "inline") {
            ...
            css += "\n/*# sourceMappingURL=".concat(path__namespace.basename(fileName), ".map */");
        }
            ...
            switch (_d.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, Promise.resolve(result.process(css, {
                            from: sassPath,
                            to: path__namespace.parse(sassPath).name + outputExt,
...
var ImportUpdater = /** @class */ (function () {
    ...
    ImportUpdater.prototype.saveAndGetUpdatedImportPath = function (assetId, _a) {
        ...
        var updatedImport = path__namespace
            .relative(path__namespace.dirname(path__namespace.resolve(bundleOutDir, chunk.fileName)), assetOutput)
            .replace(/\\/g, "/");
        this._pluginContext.stylesToEmit[assetId].output = path__namespace.relative(path__namespace.resolve(bundleOutDir), assetOutput);
    ...
    ImportUpdater.prototype.resolveOutputPath = function (bundleOutDir, assetId, moduleRoot) {
        ...
        if (typeof outputPath === "function") {
            ...
            newPath = path__namespace.resolve(bundleOutDir, outputDir, outputPath !== "keep" ? outputPath : path__namespace.relative(moduleRoot, assetId));
            assertLocation(bundleOutDir, newPath);
        }
        else {
...
var ensureCodeAndWatchList = function (filePath, stylesInfo, isWatch, compilerOptions) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = stylesInfo;
                return [4 /*yield*/, promises.readFile(filePath, "utf8")];
            case 1:
                _a.css = _c.sent();
                return [3 /*break*/, 4];
            ...
            case 4:
                ...
                stylesInfo.watchList = outWatchList.map(function (watchFile) { return path__namespace.resolve(watchFile.replace(FILE_URL_PREFIX, "")); });
                return [2 /*return*/];
        }
    });
}); };
function keepCssImports(_a) {
    ...
    var stylesOutputOptions = {
        ...
        outputExt: outputExt,
        outputDir: options.outputDir ? path__namespace.resolve(options.outputDir) : "./",
    ...
    return {
            ...
            if (this.meta.watchMode) {
                ...
                Object.values(context.stylesToEmit).forEach(function (styleInfo) {
                    return styleInfo.watchList.forEach(function (watchFile) {
                        if (!allWatched_1.find(function (watched) { return path__namespace.normalize(watched) === path__namespace.normalize(watchFile); })) {
                            _this.addWatchFile(watchFile);
                        }
                    });
                });
        ...
        watchChange: function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            resolvedId = path__namespace.resolve(id);
        ...
        renderChunk: function (code, chunk, outputOptions) {
            var bundleOutDir = path__namespace.resolve(outputOptions.dir || path__namespace.dirname(outputOptions.file));
