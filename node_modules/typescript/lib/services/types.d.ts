import { CancellationToken, CompilerHost, CompilerOptions, CustomTransformers, Diagnostic, DiagnosticWithLocation, DocumentHighlights, DocumentPositionMapper, EmitOutput, ExportInfoMap, ExportMapInfoKey, FileReference, GetEffectiveTypeRootsHost, HasChangedAutomaticTypeDirectiveNames, HasInvalidatedResolutions, JSDocParsingMode, LineAndCharacter, MinimalResolutionCacheHost, ModuleResolutionCache, ModuleSpecifierCache, ParsedCommandLine, Path, Program, ProjectReference, ResolutionMode, ResolvedModule, ResolvedModuleWithFailedLookupLocations, ResolvedProjectReference, ResolvedTypeReferenceDirective, ResolvedTypeReferenceDirectiveWithFailedLookupLocations, ScriptKind, SourceFile, SourceFileLike, SourceMapper, StringLiteralLike, Symbol, SymlinkCache, TextChangeRange, textChanges, TextRange, TextSpan, UserPreferences } from "./_namespaces/ts.js";
...
/** @internal */
export declare const emptyOptions: {};
export type WithMetadata<T> = T & {
    metadata?: unknown;
};
export declare const enum SemanticClassificationFormat {
    Original = "original",
    TwentyTwenty = "2020"
}
/** @internal */
...
export declare const enum OrganizeImportsMode {
    All = "All",
...
export declare const enum InlayHintKind {
    Type = "Type",
    Parameter = "Parameter",
    Enum = "Enum"
}
...
export declare const enum HighlightSpanKind {
    none = "none",
...
/** @internal */
export declare const testFormatSettings: FormatCodeSettings;
...
export declare const enum OutliningSpanKind {
...
export declare const enum OutputFileType {
    JavaScript = 0,
    SourceMap = 1,
    Declaration = 2
}
...
export declare const enum ClassificationTypeNames {
    comment = "comment",
