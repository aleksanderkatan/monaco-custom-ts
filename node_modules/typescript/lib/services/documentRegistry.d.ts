import { CompilerOptions, CreateSourceFileOptions, IScriptSnapshot, JSDocParsingMode, MinimalResolutionCacheHost, Path, ResolutionMode, ScriptKind, ScriptTarget, SourceFile } from "./_namespaces/ts.js";
/**
...
/** @internal */
export declare function isDocumentRegistryEntry(entry: BucketEntry): entry is DocumentRegistryEntry;
export declare function createDocumentRegistry(useCaseSensitiveFileNames?: boolean, currentDirectory?: string, jsDocParsingMode?: JSDocParsingMode): DocumentRegistry;
/** @internal */
export type DocumentRegistryBucketKeyWithMode = string & {
    __documentRegistryBucketKeyWithMode: any;
};
/** @internal */
export declare function createDocumentRegistryInternal(useCaseSensitiveFileNames?: boolean, currentDirectory?: string, jsDocParsingMode?: JSDocParsingMode, externalCache?: ExternalDocumentCache): DocumentRegistry;
