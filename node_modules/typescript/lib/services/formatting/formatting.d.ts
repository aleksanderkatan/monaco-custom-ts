import { RulesMap } from "../_namespaces/ts.formatting.js";
import { CommentRange, EditorSettings, FormatCodeSettings, FormattingHost, LanguageVariant, Node, SourceFile, SourceFileLike, SyntaxKind, TextChange, TextRange, TriviaSyntaxKind } from "../_namespaces/ts.js";
/** @internal */
 ...
 * @internal
 */
export declare function getRangeOfEnclosingComment(sourceFile: SourceFile, position: number, precedingToken?: Node | null, // eslint-disable-line no-restricted-syntax
