import { CancellationToken, CodeAction, CompilerOptions, CompletionEntry, CompletionEntryData, CompletionEntryDetails, CompletionInfo, CompletionsTriggerCharacter, CompletionTriggerKind, formatting, Identifier, JSDocTagInfo, JsxAttributes, LanguageServiceHost, Node, ObjectLiteralExpression, Program, PropertyAccessExpression, ScriptElementKind, ScriptTarget, SortedArray, SourceFile, Symbol, SymbolDisplayPart, TextSpan, TokenSyntaxKind, Type, TypeChecker, UserPreferences } from "./_namespaces/ts.js";
/** @internal */
...
/** @internal */
export declare function getDefaultCommitCharacters(isNewIdentifierLocation: boolean): string[];
/** @internal */
