import { __String, AnyImportOrRequireStatement, BindingElement, BlockLike, BreakOrContinueStatement, CallExpression, CaseClause, CommentKind, CommentRange, CompilerOptions, ContextFlags, Declaration, DefaultClause, Diagnostic, DiagnosticAndArguments, DiagnosticMessage, DiagnosticWithLocation, DisplayPartsSymbolWriter, DocumentPosition, DocumentSpan, EqualityComparer, EqualityOperator, Expression, FileTextChanges, FormatCodeSettings, formatting, FormattingHost, FutureSourceFile, Identifier, ImportClause, ImportDeclaration, ImportSpecifier, IScriptSnapshot, JSDocLink, JSDocLinkCode, JSDocLinkPlain, JsxEmit, LanguageServiceHost, Modifier, ModifierFlags, ModuleKind, ModuleResolutionHost, ModuleResolutionKind, ModuleSpecifierResolutionHost, NewLineKind, Node, NodeArray, NoSubstitutionTemplateLiteral, NumericLiteral, Program, ProjectPackageJsonInfo, PropertyName, PseudoBigInt, RefactorContext, Scanner, ScriptElementKind, ScriptKind, ScriptTarget, Signature, SourceFile, SourceFileLike, SourceMapper, StringLiteral, StringLiteralLike, Symbol, SymbolDisplayPart, SymbolDisplayPartKind, SymbolFlags, SymbolFormatFlags, SymbolTracker, SyntaxKind, SyntaxList, TaggedTemplateExpression, TemplateExpression, TemplateLiteralToken, TextChange, textChanges, TextRange, TextSpan, Token, Type, TypeChecker, TypeFormatFlags, TypeNode, UserPreferences, WriterContextOut } from "./_namespaces/ts.js";
/** @internal */
...
/** @internal */
export declare function getReplacementSpanForContextToken(contextToken: Node | undefined, position: number): TextSpan | undefined;
/** @internal */
export declare function createTextSpanFromNode(node: Node, sourceFile?: SourceFile, endNode?: Node): TextSpan;
/** @internal */
export declare function createTextSpanFromStringLiteralLikeContent(node: StringLiteralLike, position: number): TextSpan | undefined;
/** @internal */
...
/** @internal */
export declare function getQuotePreference(sourceFile: SourceFile | FutureSourceFile, preferences: UserPreferences): QuotePreference;
/** @internal */
...
/** @internal */
export declare function insertImports(changes: textChanges.ChangeTracker, sourceFile: SourceFile | FutureSourceFile, imports: AnyImportOrRequireStatement | readonly AnyImportOrRequireStatement[], blankLineBetween: boolean, preferences: UserPreferences): void;
/** @internal */
...
/** @internal */
export declare function documentSpansEqual(a: DocumentSpan, b: DocumentSpan, useCaseSensitiveFileNames: boolean): boolean;
/** @internal */
export declare function getDocumentSpansEqualityComparer(useCaseSensitiveFileNames: boolean): EqualityComparer<DocumentSpan>;
/**
...
/** @internal */
export declare function mapToDisplayParts(writeDisplayParts: (writer: DisplayPartsSymbolWriter) => void, maximumLength?: number): SymbolDisplayPart[];
/** @internal */
export declare function typeToDisplayParts(typechecker: TypeChecker, type: Type, enclosingDeclaration?: Node, flags?: TypeFormatFlags, maximumLength?: number, verbosityLevel?: number, out?: WriterContextOut): SymbolDisplayPart[];
/** @internal */
...
/** @internal */
export declare function signatureToDisplayParts(typechecker: TypeChecker, signature: Signature, enclosingDeclaration?: Node, flags?: TypeFormatFlags, maximumLength?: number, verbosityLevel?: number, out?: WriterContextOut): SymbolDisplayPart[];
/** @internal */
...
/** @internal */
export declare function findPackageJsons(startDirectory: string, host: LanguageServiceHost): string[];
/** @internal */
...
/** @internal */
export declare function createPackageJsonImportFilter(fromFile: SourceFile | FutureSourceFile, preferences: UserPreferences, host: LanguageServiceHost): PackageJsonImportFilter;
/** @internal */
 ...
 * @internal
 */
export declare function getDefaultLikeExportNameFromDeclaration(symbol: Symbol): string | undefined;
/** @internal */
...
/** @internal */
export declare function shouldUseUriStyleNodeCoreModules(file: SourceFile | FutureSourceFile, program: Program): boolean | undefined;
/** @internal */
...
/** @internal */
export declare function jsxModeNeedsExplicitImport(jsx: JsxEmit | undefined): jsx is JsxEmit.React | JsxEmit.ReactNative;
/** @internal */
...
/** @internal */
export declare function isBlockLike(node: Node): node is BlockLike;
/** @internal */
export declare function createFutureSourceFile(fileName: string, syntaxModuleIndicator: ModuleKind.ESNext | ModuleKind.CommonJS | undefined, program: Program, moduleResolutionHost: ModuleResolutionHost): FutureSourceFile;
