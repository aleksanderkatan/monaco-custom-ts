import { UnionToIntersection, Version } from "./_namespaces/ts.js";
/** @internal */
...
/** @internal @knipignore */
export declare function createOverload<T extends OverloadDefinitions>(name: string, overloads: T, binder: OverloadBinders<T>, deprecations?: OverloadDeprecations<T>): OverloadFunction<T>;
/** @internal */
