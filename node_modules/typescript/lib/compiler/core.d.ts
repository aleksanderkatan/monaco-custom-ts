import { Comparer, Comparison, EqualityComparer, MapLike, Queue, SortedArray, SortedReadonlyArray, TextSpan } from "./_namespaces/ts.js";
/** @internal */
...
/** @internal */
export declare function filter<T>(array: readonly T[], f: (x: T) => boolean): readonly T[];
/** @internal */
...
/** @internal */
export declare function filter<T>(array: readonly T[] | undefined, f: (x: T) => boolean): readonly T[] | undefined;
/** @internal */
 ...
 * @internal
 */
export declare function flatMap<T, U extends {}>(array: readonly T[] | undefined, mapfn: (x: T, i: number) => U | readonly U[] | undefined): readonly U[];
/** @internal */
export declare function flatMapToMutable<T, U>(array: readonly T[] | undefined, mapfn: (x: T, i: number) => U | readonly U[] | undefined): U[];
/** @internal */
export declare function flatMapIterator<T, U>(iter: Iterable<T>, mapfn: (x: T) => readonly U[] | Iterable<U> | undefined): Generator<U, void, any>;
/**
 * Maps an array. If the mapped value is an array, it is spread into the result.
...
/** @internal */
export declare function insertSorted<T>(array: SortedArray<T>, insert: T, compare: Comparer<T>, equalityComparer?: EqualityComparer<T>, allowDuplicates?: boolean): boolean;
/** @internal */
export declare function sortAndDeduplicate(array: readonly string[]): SortedReadonlyArray<string>;
/** @internal */
 ...
 * @internal
 */
export declare function append<T extends {}>(to: T[], value: T | undefined): T[];
/** @internal */
export declare function append<T extends {}>(to: T[] | undefined, value: T): T[];
/** @internal */
export declare function append<T extends {}>(to: T[] | undefined, value: T | undefined): T[] | undefined;
/**
 ...
 * @internal
 */
export declare function combine<T extends {}>(xs: T[] | undefined, ys: T[] | undefined): T[] | undefined;
/** @internal */
export declare function combine<T extends {}>(xs: T | readonly T[] | undefined, ys: T | readonly T[] | undefined): T | readonly T[] | undefined;
/** @internal */
export declare function combine<T extends {}>(xs: T | T[] | undefined, ys: T | T[] | undefined): T | T[] | undefined;
/**
 ...
 * @internal
 */
export declare function toSorted<T>(array: readonly T[], comparer?: Comparer<T>): SortedReadonlyArray<T>;
/** @internal */
...
/** @internal */
export declare function maxBy<T>(arr: readonly T[], init: number, mapper: (x: T) => number): number;
/** @internal */
 ...
 * @internal
 */
export declare function getSpellingSuggestion<T>(name: string, candidates: Iterable<T>, getName: (candidate: T) => string | undefined): T | undefined;
/** @internal */
