import { BaseNodeFactory, Diagnostic, DiagnosticMessage, EntityName, JSDoc, JSDocParsingMode, JSDocTypeExpression, JsonSourceFile, JsxTagNameExpression, Node, NodeArray, NodeFactory, PackageJsonInfo, PragmaContext, ResolutionMode, ScriptKind, ScriptTarget, SourceFile, TextChangeRange } from "./_namespaces/ts.js";
/**
...
/** @internal */
export declare function parseIsolatedJSDocComment(content: string, start?: number, length?: number): JsDocWithDiagnostics | undefined;
/** @internal */
...
/** @internal */
export declare function getDeclarationFileExtension(fileName: string): string | undefined;
/** @internal */
