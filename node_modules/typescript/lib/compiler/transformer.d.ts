import { CompilerOptions, CustomTransformers, EmitHint, EmitHost, EmitOnly, EmitResolver, EmitTransformers, Node, NodeFactory, TransformationContext, TransformationResult, TransformerFactory } from "./_namespaces/ts.js";
/** @internal */
