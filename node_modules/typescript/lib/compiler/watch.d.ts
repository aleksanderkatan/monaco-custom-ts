...
/** @internal */
export declare function isBuilderProgram<T extends BuilderProgram>(program: Program | BuilderProgram): program is T;
/** @internal */
export declare function explainFiles(program: Program, write: (s: string) => void): void;
/** @internal */
export declare function explainIfFileIsRedirectAndImpliedFormat(file: SourceFile, options: CompilerOptions, fileNameConvertor?: (fileName: string) => string): DiagnosticMessageChain[] | undefined;
/** @internal */
...
/** @internal */
export declare function performIncrementalCompilation(input: IncrementalCompilationOptions): ExitStatus;
