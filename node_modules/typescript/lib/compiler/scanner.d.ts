import { CharacterCodes, CommentDirective, CommentKind, CommentRange, DiagnosticMessage, JSDocParsingMode, JSDocSyntaxKind, JsxTokenSyntaxKind, KeywordSyntaxKind, LanguageVariant, LineAndCharacter, MapLike, PunctuationOrKeywordSyntaxKind, RegularExpressionFlags, ScriptKind, ScriptTarget, SourceFileLike, SyntaxKind, TokenFlags } from "./_namespaces/ts.js";
...
/** @internal */
export declare function isUnicodeIdentifierStart(code: number, languageVersion: ScriptTarget | undefined): boolean;
/** @internal */
...
/** @internal @knipignore */
export declare function regularExpressionFlagToCharacterCode(f: RegularExpressionFlags): CharacterCodes | undefined;
/** @internal @knipignore */
export declare function characterCodeToRegularExpressionFlag(ch: CharacterCodes): RegularExpressionFlags | undefined;
/** @internal */
