import { AnyFunction, AssertionLevel, CheckMode, EmitFlags, FlowFlags, FlowNode, ModifierFlags, Node, NodeArray, NodeCheckFlags, NodeFlags, ObjectFlags, RelationComparisonResult, ScriptKind, SignatureCheckMode, SignatureFlags, SnippetKind, Symbol, SymbolFlags, SyntaxKind, TransformFlags, Type, TypeFacts, TypeFlags, TypeMapKind, TypeMapper, VarianceFlags } from "./_namespaces/ts.js";
/** @internal */
