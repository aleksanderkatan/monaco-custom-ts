import { __String, AccessExpression, AccessorDeclaration, AllAccessorDeclarations, AmbientModuleDeclaration, AmpersandAmpersandEqualsToken, AnyImportOrBareOrAccessedRequire, AnyImportOrReExport, type AnyImportOrRequireStatement, AnyImportSyntax, AnyValidImportOrReExport, ArrowFunction, AssignmentDeclarationKind, AssignmentExpression, AssignmentOperatorToken, BarBarEqualsToken, BinaryExpression, BindableObjectDefinePropertyCall, BindableStaticAccessExpression, BindableStaticElementAccessExpression, BindableStaticNameExpression, BindingElement, BindingElementOfBareOrAccessedRequire, Block, CallExpression, CallLikeExpression, CallSignatureDeclaration, CanHaveModuleSpecifier, CanonicalDiagnostic, CaseBlock, CaseClause, CatchClause, CharacterCodes, CheckFlags, ClassDeclaration, ClassElement, ClassExpression, ClassLikeDeclaration, ClassStaticBlockDeclaration, CommandLineOption, CommentDirective, CommentDirectivesMap, CommentRange, Comparison, CompilerOptions, CompilerOptionsValue, ComputedPropertyName, ConstructorDeclaration, ConstructSignatureDeclaration, Declaration, DeclarationName, DeclarationWithTypeParameterChildren, DeclarationWithTypeParameters, DefaultClause, DestructuringAssignment, Diagnostic, DiagnosticArguments, DiagnosticCollection, DiagnosticMessage, DiagnosticMessageChain, DiagnosticRelatedInformation, DiagnosticWithDetachedLocation, DiagnosticWithLocation, DoStatement, DynamicNamedBinaryExpression, DynamicNamedDeclaration, ElementAccessExpression, EmitFlags, EmitHost, EmitResolver, EmitTextWriter, EntityName, EntityNameExpression, EntityNameOrEntityNameExpression, EnumDeclaration, EqualityComparer, EqualsToken, EvaluationResolver, EvaluatorResult, ExportAssignment, ExportDeclaration, ExportSpecifier, Expression, ExpressionWithTypeArguments, Extension, ExternalModuleReference, FileExtensionInfo, FileReference, FileWatcher, ForInOrOfStatement, ForStatement, FunctionBody, FunctionDeclaration, FunctionExpression, FunctionLikeDeclaration, GetAccessorDeclaration, GetCanonicalFileName, HasExpressionInitializer, HasFlowNode, HasInferredType, HasJSDoc, HasModifiers, HasTypeArguments, HeritageClause, Identifier, IdentifierTypePredicate, IfStatement, ImportAttribute, ImportCall, ImportClause, ImportDeclaration, ImportEqualsDeclaration, ImportMetaProperty, ImportSpecifier, ImportTypeNode, IndexInfo, IndexSignatureDeclaration, InitializedVariableDeclaration, InstanceofExpression, InterfaceDeclaration, InternalEmitFlags, IntroducesNewScopeNode, JSDoc, JSDocCallbackTag, JSDocEnumTag, JSDocImportTag, JSDocMemberName, JSDocOverloadTag, JSDocParameterTag, JSDocSatisfiesExpression, JSDocSignature, JSDocTag, JSDocTemplateTag, JSDocTypedefTag, JsonSourceFile, JsxAttributeName, JsxChild, JsxNamespacedName, JsxTagNameExpression, KeywordSyntaxKind, LabeledStatement, LanguageVariant, LateVisibilityPaintedStatement, LiteralImportTypeNode, LiteralLikeElementAccessExpression, LiteralLikeNode, LogicalOperator, LogicalOrCoalescingAssignmentOperator, MapLike, MemberName, MethodDeclaration, MethodSignature, ModeAwareCache, ModifierFlags, ModifierLike, ModuleDeclaration, ModuleDetectionKind, ModuleExportName, ModuleKind, ModuleResolutionKind, MultiMap, NamedImportsOrExports, NamespaceExport, NamespaceImport, Node, NodeArray, NodeFlags, NoSubstitutionTemplateLiteral, NumberLiteralType, NumericLiteral, ObjectFlags, ObjectLiteralElement, ObjectLiteralExpression, ObjectTypeDeclaration, PackageId, ParameterDeclaration, ParenthesizedTypeNode, Path, Pattern, PrefixUnaryExpression, PrimitiveLiteral, PrinterOptions, PrintHandlers, PrivateIdentifier, ProjectReference, PrologueDirective, PropertyAccessEntityNameExpression, PropertyAccessExpression, PropertyAssignment, PropertyDeclaration, PropertyName, PropertyNameLiteral, PropertySignature, PseudoBigInt, PunctuationOrKeywordSyntaxKind, PunctuationSyntaxKind, QualifiedName, QuestionQuestionEqualsToken, ReadonlyCollection, ReadonlyTextRange, RequireOrImportCall, RequireVariableStatement, ResolutionMode, ResolvedModuleFull, ResolvedModuleWithFailedLookupLocations, ResolvedProjectReference, ResolvedTypeReferenceDirective, ResolvedTypeReferenceDirectiveWithFailedLookupLocations, ReturnStatement, ScriptKind, ScriptTarget, SetAccessorDeclaration, ShorthandPropertyAssignment, Signature, SignatureDeclaration, SignatureFlags, SourceFile, SourceFileLike, SourceFileMayBeEmittedHost, SourceMapSource, Statement, StringLiteral, StringLiteralLike, StringLiteralType, SuperCall, SuperProperty, SwitchStatement, Symbol, SymbolFlags, SymbolTable, SyntaxKind, TemplateExpression, TemplateLiteral, TextRange, TextSpan, ThisTypePredicate, Token, TransientSymbol, TriviaSyntaxKind, TryStatement, TsConfigSourceFile, Type, TypeAliasDeclaration, TypeChecker, TypeCheckerHost, TypeElement, TypeFlags, TypeNode, TypeNodeSyntaxKind, TypeParameterDeclaration, TypePredicate, TypeReferenceNode, UniqueESSymbolType, UserPreferences, VariableDeclaration, VariableDeclarationInitializedTo, VariableDeclarationList, VariableLikeDeclaration, VariableStatement, WhileStatement, WithStatement, WrappedExpression, WriteFileCallback, WriteFileCallbackData, YieldExpression } from "./_namespaces/ts.js";
/** @internal */
...
/** @internal */
export declare const defaultHoverMaximumTruncationLength = 500;
/** @internal */
...
/** @internal */
export declare function getResolvedModuleFromResolution(resolution: ResolvedModuleWithFailedLookupLocations): ResolvedModuleFull | undefined;
/** @internal */
export declare function getResolvedTypeReferenceDirectiveFromResolution(resolution: ResolvedTypeReferenceDirectiveWithFailedLookupLocations): ResolvedTypeReferenceDirective | undefined;
/** @internal */
...
/** @internal */
export declare function createModeMismatchDetails(currentSourceFile: SourceFile): DiagnosticMessageChain;
/** @internal */
...
/** @internal */
export declare function hasChangesInResolutions<K, V>(names: readonly K[], newResolutions: readonly V[], getOldResolution: (name: K) => V | undefined, comparer: (oldResolution: V, newResolution: V) => boolean): boolean;
/** @internal */
...
/** @internal */
export declare function getNonModifierTokenPosOfNode(node: Node, sourceFile?: SourceFileLike): number;
/** @internal */
...
/** @internal */
export declare function moduleExportNameTextUnescaped(node: ModuleExportName): string;
/** @internal */
export declare function moduleExportNameTextEscaped(node: ModuleExportName): __String;
/**
 ...
 * @internal
 */
export declare function moduleExportNameIsDefault(node: ModuleExportName): boolean;
/** @internal */
...
/** @internal */
export declare const getScriptTargetFeatures: () => ScriptTargetFeatures;
/** @internal */
...
/** @internal */
export declare function isAnyImportOrRequireStatement(node: Node): node is AnyImportOrRequireStatement;
/** @internal */
...
/** @internal */
export declare function getEnclosingContainer(node: Node): Node | undefined;
/** @internal */
...
/** @internal */
export declare function getCanonicalDiagnostic(message: DiagnosticMessage, ...args: string[]): CanonicalDiagnostic;
/** @internal */
...
/** @internal */
export declare function isGlobalSourceFile(node: Node): boolean;
/** @internal */
 ...
 * @internal
 */
export declare function isVarAwaitUsing(node: VariableDeclaration | VariableDeclarationList): boolean;
/**
 * Gets whether a bound `VariableDeclaration` or `VariableDeclarationList` is part of a `using` declaration.
 * @internal
 */
export declare function isVarUsing(node: VariableDeclaration | VariableDeclarationList): boolean;
/**
 ...
 * @internal
 */
export declare function isVarConstLike(node: VariableDeclaration | VariableDeclarationList): boolean;
/**
...
/** @internal */
export declare function getContainingClassExcludingClassDecorators(node: Node): ClassLikeDeclaration | undefined;
/** @internal */
...
/** @internal */
export declare function getNewTargetContainer(node: Node): FunctionDeclaration | ConstructorDeclaration | FunctionExpression | undefined;
/** @internal */
...
/** @internal */
export declare function isFullSourceFile(sourceFile: object): sourceFile is SourceFile;
/** @internal */
...
/** @internal */
export declare function canHaveModuleSpecifier(node: Node | undefined): node is CanHaveModuleSpecifier;
/** @internal */
export declare function tryGetModuleSpecifierFromDeclaration(node: CanHaveModuleSpecifier | JSDocImportTag): StringLiteralLike | undefined;
/** @internal */
...
/** @internal */
export declare function shouldRewriteModuleSpecifier(specifier: string, compilerOptions: CompilerOptions): boolean;
/** @internal */
export declare function getExternalModuleName(node: AnyImportOrReExport | ImportTypeNode | ImportCall | ModuleDeclaration | JSDocImportTag): Expression | undefined;
/** @internal */
...
/** @internal */
export declare function isDefaultImport(node: ImportDeclaration | ImportEqualsDeclaration | ExportDeclaration | JSDocImportTag): boolean;
/** @internal */
...
/** @internal */
export declare function getEffectiveContainerForJSDocTemplateTag(node: JSDocTemplateTag): SignatureDeclaration | JSDocTypedefTag | JSDocCallbackTag | JSDocEnumTag | undefined;
/** @internal */
export declare function getJSDocOverloadTags(node: Node): readonly JSDocOverloadTag[];
/** @internal */
...
/** @internal */
export declare function isInCompoundLikeAssignment(node: Node): boolean;
/** @internal */
export type NodeWithPossibleHoistedDeclaration = Block | VariableStatement | WithStatement | IfStatement | SwitchStatement | CaseBlock | CaseClause | DefaultClause | LabeledStatement | ForStatement | ForInOrOfStatement | DoStatement | WhileStatement | TryStatement | CatchClause;
/**
...
export declare const enum FunctionFlags {
    ...
    Generator = 1,// Function is a generator function or async generator function
    Async = 2,// Function is an async function or an async generator function
    Invalid = 4,// Function is a signature or overload and does not have a body.
    AsyncGenerator = 3
}
/** @internal */
 ...
 * @internal
 */
export declare function isPartOfParameterDeclaration(node: Declaration): boolean;
/** @internal */
...
/** @internal */
export declare function escapeTemplateSubstitution(str: string): string;
/** @internal */
...
/** @internal */
export declare function getDeclarationEmitOutputFilePathWorker(fileName: string, options: CompilerOptions, host: Pick<EmitHost, "getCommonSourceDirectory" | "getCurrentDirectory" | "getCanonicalFileName">): string;
/** @internal */
...
/** @internal */
export declare function getPossibleOriginalInputPathWithoutChangingExt(filePath: string, ignoreCase: boolean, outputDir: string | undefined, getCommonSourceDirectory: () => string): string;
/**
...
/** @internal */
export declare function isInTypeQuery(node: Node): boolean;
/** @internal */
...
/** @internal */
export declare function getAllAccessorDeclarations(declarations: readonly Declaration[] | undefined, accessor: AccessorDeclaration): AllAccessorDeclarations;
/**
 ...
 * @internal
 */
export declare function emitDetachedComments(text: string, lineMap: readonly number[], writer: EmitTextWriter, writeComment: (text: string, lineMap: readonly number[], writer: EmitTextWriter, commentPos: number, commentEnd: number, newLine: string) => void, node: TextRange, newLine: string, removeComments: boolean): DetachedCommentInfo | undefined;
/** @internal */
...
/** @internal */
export declare function isInstanceOfExpression(node: Node): node is InstanceofExpression;
/** @internal */
export declare function isRightSideOfInstanceofExpression(node: Node): boolean;
/** @internal */
 ...
 * @internal
 */
export declare function mutateMapSkippingNewValues<K, T>(map: Map<K, T>, newMap: ReadonlySet<K> | undefined, options: MutateMapSkippingNewValuesDelete<K, T>): void;
/** @internal */
export declare function mutateMapSkippingNewValues<K, T, U>(map: Map<K, T>, newMap: ReadonlyMap<K, U> | undefined, options: MutateMapSkippingNewValuesOptions<K, T, U>): void;
/** @internal */
 ...
 * @internal
 */
export declare function mutateMap<K, T>(map: Map<K, T>, newMap: ReadonlySet<K> | undefined, options: MutateMapWithNewSetOptions<K, T>): void;
/** @internal */
export declare function mutateMap<K, T, U>(map: Map<K, T>, newMap: ReadonlyMap<K, U> | undefined, options: MutateMapOptions<K, T, U>): void;
/** @internal */
 ...
 * @internal
 */
export declare function addToSeen<K>(seen: Set<K>, key: K): boolean;
/** @internal */
...
/** @internal */
export declare function formatStringFromArgs(text: string, args: DiagnosticArguments): string;
/** @internal */
...
/** @internal */
export declare function createDetachedDiagnostic(fileName: string, sourceText: string, start: number, length: number, message: DiagnosticMessage, ...args: DiagnosticArguments): DiagnosticWithDetachedLocation;
/** @internal */
...
/** @internal */
export declare function formatMessage(message: DiagnosticMessage, ...args: DiagnosticArguments): string;
/** @internal */
...
/** @internal */
export declare function diagnosticsEqualityComparer(d1: Diagnostic, d2: Diagnostic): boolean;
/** @internal */
 ...
 */
export declare function importSyntaxAffectsModuleResolution(options: CompilerOptions): boolean;
/** @internal */
export declare const computedOptions: Record<string, {
    dependencies: readonly string[];
    computeValue: (options: CompilerOptions) => CompilerOptionsValue;
}>;
/** @internal */
export declare const getAllowImportingTsExtensions: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const getEmitScriptTarget: (compilerOptions: CompilerOptions) => ScriptTarget;
/** @internal */
export declare const getEmitModuleKind: (compilerOptions: Pick<CompilerOptions, "module" | "target">) => ModuleKind;
/** @internal */
export declare const getEmitModuleResolutionKind: (compilerOptions: CompilerOptions) => ModuleResolutionKind;
/** @internal @knipignore */
export declare const getEmitModuleDetectionKind: (compilerOptions: CompilerOptions) => ModuleDetectionKind;
/** @internal */
export declare const getIsolatedModules: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const getESModuleInterop: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const getAllowSyntheticDefaultImports: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const getResolvePackageJsonExports: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const getResolvePackageJsonImports: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const getResolveJsonModule: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const getEmitDeclarations: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const shouldPreserveConstEnums: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const isIncrementalCompilation: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const getAreDeclarationMapsEnabled: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const getAllowJSCompilerOption: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
export declare const getUseDefineForClassFields: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
 ...
 */
export declare function moduleSupportsImportAttributes(moduleKind: ModuleKind): boolean;
/** @internal */
export type StrictOptionName = "noImplicitAny" | "noImplicitThis" | "strictNullChecks" | "strictFunctionTypes" | "strictBindCallApply" | "strictPropertyInitialization" | "strictBuiltinIteratorReturn" | "alwaysStrict" | "useUnknownInCatchVariables";
/** @internal */
export declare function getStrictOptionValue(compilerOptions: CompilerOptions, flag: StrictOptionName): boolean;
/** @internal */
export declare function getNameOfScriptTarget(scriptTarget: ScriptTarget): string | undefined;
/** @internal */
export declare function getEmitStandardClassFields(compilerOptions: CompilerOptions): boolean;
/** @internal */
...
/** @internal */
export declare function getSubPatternFromSpec(spec: string, basePath: string, usage: "files" | "directories" | "exclude", { singleAsteriskRegexFragment, doubleAsteriskRegexFragment, replaceWildcardCharacter }?: WildcardMatcher): string | undefined;
/** @internal */
...
/** @internal */
export declare function hasImplementationTSFileExtension(fileName: string): boolean;
/**
 * @internal
 ...
 * @internal
 */
export declare function tryParsePatterns(paths: MapLike<string[]>): ParsedPatterns;
/** @internal */
 ...
 * @internal
 */
export declare function matchPatternOrExact(parsedPatterns: ParsedPatterns, candidate: string): string | Pattern | undefined;
/** @internal */
...
/** @internal */
export declare function skipTypeCheckingIgnoringNoCheck(sourceFile: SourceFile, options: CompilerOptions, host: HostWithIsSourceOfProjectReferenceRedirect): boolean;
/** @internal */
export declare function canIncludeBindAndCheckDiagnostics(sourceFile: SourceFile, options: CompilerOptions): boolean;
/** @internal */
...
/** @internal */
export declare function createPropertyNameNodeForIdentifierOrLiteral(name: string, target: ScriptTarget, singleQuote: boolean, stringNamed: boolean, isMethod: boolean): Identifier | StringLiteral | NumericLiteral;
/** @internal */
...
/** @internal */
export declare function isOptionalJSDocPropertyLikeTag(node: Node): boolean;
/** @internal */
 ...
 * @internal
 */
export declare function isTypeUsableAsPropertyName(type: Type): type is StringLiteralType | NumberLiteralType | UniqueESSymbolType;
/**
 * Gets the symbolic name for a member from its type.
 * @internal
 */
export declare function getPropertyNameFromType(type: StringLiteralType | NumberLiteralType | UniqueESSymbolType): __String;
/** @internal */
export declare function isExpandoPropertyDeclaration(declaration: Declaration | undefined): declaration is PropertyAccessExpression | ElementAccessExpression | BinaryExpression;
/** @internal */
export declare function hasResolutionModeOverride(node: ImportTypeNode | ImportDeclaration | ExportDeclaration | JSDocImportTag | undefined): boolean;
/** @internal */
export declare function replaceFirstStar(s: string, replacement: string): string;
/** @internal */
export declare function getNameFromImportAttribute(node: ImportAttribute): __String;
/** @internal */
export declare function isSourceElement(node: Node): boolean;
/** @internal */
export declare function evaluatorResult<T extends string | number | undefined>(value: T, isSyntacticallyString?: boolean, resolvedOtherFiles?: boolean, hasExternalReferences?: boolean): EvaluatorResult<T>;
/** @internal */
export declare function createEvaluator({ evaluateElementAccessExpression, evaluateEntityNameExpression }: EvaluationResolver): {
...
/** @internal */
export declare function isConstAssertion(location: Node): boolean;
/** @internal */
export declare function findConstructorDeclaration(node: ClassLikeDeclaration): ConstructorDeclaration | undefined;
/** @internal */
...
/** @internal */
export type NameResolver = (location: Node | undefined, nameArg: __String | Identifier, meaning: SymbolFlags, nameNotFoundMessage: DiagnosticMessage | undefined, isUse: boolean, excludeGlobals?: boolean) => Symbol | undefined;
/** @internal */
export declare function createNameResolver({ compilerOptions, requireSymbol, argumentsSymbol, error, getSymbolOfDeclaration, globals, lookup, setRequiresScopeChangeCache, getRequiresScopeChangeCache, onPropertyWithInvalidInitializer, onFailedToResolveSymbol, onSuccessfullyResolvedSymbol, }: NameResolverOptions): NameResolver;
/** @internal */
export declare function isPrimitiveLiteralValue(node: Expression, includeBigInt?: boolean): node is PrimitiveLiteral;
/** @internal */
export declare function unwrapParenthesizedExpression(o: Expression): Expression;
/** @internal */
export declare function hasInferredType(node: Node): node is HasInferredType;
/** @internal */
export declare function isSideEffectImport(node: Node): boolean;
/** @internal */
export declare const unprefixedNodeCoreModules: Set<string>;
/** @internal */
export declare const exclusivelyPrefixedNodeCoreModules: Set<string>;
/** @internal */
export declare const nodeCoreModules: Set<string>;
/** @internal */
export declare function forEachDynamicImportOrRequireCall<IncludeTypeSpaceImports extends boolean, RequireStringLiteralLikeArgument extends boolean>(file: SourceFile, includeTypeSpaceImports: IncludeTypeSpaceImports, requireStringLiteralLikeArgument: RequireStringLiteralLikeArgument, cb: (node: CallExpression | (IncludeTypeSpaceImports extends false ? never : JSDocImportTag | ImportTypeNode), argument: RequireStringLiteralLikeArgument extends true ? StringLiteralLike : Expression) => void): void;
/** @internal */
export declare function isNewScopeNode(node: Node): node is IntroducesNewScopeNode;
/** @internal */
export declare function getLibNameFromLibReference(libReference: FileReference): string;
/** @internal */
export declare function getLibFileNameFromLibReference(libReference: FileReference): string | undefined;
/** @internal */
export declare function forEachResolvedProjectReference<T>(resolvedProjectReferences: readonly (ResolvedProjectReference | undefined)[] | undefined, cb: (resolvedProjectReference: ResolvedProjectReference) => T | undefined): T | undefined;
/** @internal */
export declare function forEachProjectReference<T>(projectReferences: readonly ProjectReference[] | undefined, resolvedProjectReferences: readonly (ResolvedProjectReference | undefined)[] | undefined, cbResolvedRef: (resolvedRef: ResolvedProjectReference | undefined, parent: ResolvedProjectReference | undefined, index: number) => T | undefined, cbRef?: (projectReferences: readonly ProjectReference[] | undefined, parent: ResolvedProjectReference | undefined) => T | undefined): T | undefined;
/** @internal */
export declare function getOptionsSyntaxByArrayElementValue(optionsObject: ObjectLiteralExpression | undefined, name: string, value: string): StringLiteral | undefined;
/** @internal */
export declare function getOptionsSyntaxByValue(optionsObject: ObjectLiteralExpression | undefined, name: string, value: string): StringLiteral | undefined;
/** @internal */
export declare function forEachOptionsSyntaxByName<T>(optionsObject: ObjectLiteralExpression | undefined, name: string, callback: (prop: PropertyAssignment) => T | undefined): T | undefined;
/**
