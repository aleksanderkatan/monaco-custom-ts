import { AccessExpression, AutoGenerateInfo, EmitFlags, EmitHelper, EmitNode, Identifier, ImportSpecifier, InternalEmitFlags, Node, NodeArray, PrivateIdentifier, SnippetElement, SourceFile, SourceMapRange, SyntaxKind, SynthesizedComment, TextRange, TypeNode, TypeParameterDeclaration } from "../_namespaces/ts.js";
/**
