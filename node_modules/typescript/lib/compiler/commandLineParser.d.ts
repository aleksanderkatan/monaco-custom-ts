...
/** @internal */
export declare const commandLineOptionOfCustomType: readonly CommandLineOptionOfCustomType[];
/** @internal */
export declare const tscBuildOption: CommandLineOption;
/** @internal */
...
/** @internal */
export declare function parseCustomTypeOption(opt: CommandLineOptionOfCustomType, value: string | undefined, errors: Diagnostic[]): string | number | undefined;
/** @internal */
...
/** @internal */
export declare function parseCommandLineWorker(diagnostics: ParseCommandLineWorkerDiagnostics, commandLine: readonly string[], readFile?: (path: string) => string | undefined): BaseParsedCommandLine;
/** @internal */
...
export declare function parseBuildCommand(commandLine: readonly string[]): ParsedBuildCommand;
/** @internal */
export declare function getDiagnosticText(message: DiagnosticMessage, ...args: any[]): string;
 ...
 * @internal
 */
export declare function generateTSConfig(options: CompilerOptions, newLine: string): string;
/** @internal */
...
/** @internal */
export declare function handleWatchOptionsConfigDirTemplateSubstitution(watchOptions: WatchOptions | undefined, basePath: string): WatchOptions | undefined;
/** @internal */
export declare function isSolutionConfig(config: ParsedCommandLine): boolean;
/** @internal */
...
/** @internal */
export declare function matchesExcludeWorker(pathToCheck: string, excludeSpecs: readonly string[] | undefined, useCaseSensitiveFileNames: boolean, currentDirectory: string, basePath?: string): boolean;
/**
