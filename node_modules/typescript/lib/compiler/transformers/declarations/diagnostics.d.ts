import { BinaryExpression, BindingElement, CallSignatureDeclaration, ConstructorDeclaration, ConstructSignatureDeclaration, DeclarationName, DiagnosticMessage, DiagnosticWithLocation, ElementAccessExpression, EmitResolver, ExpressionWithTypeArguments, FunctionDeclaration, GetAccessorDeclaration, ImportEqualsDeclaration, IndexSignatureDeclaration, JSDocCallbackTag, JSDocEnumTag, JSDocTypedefTag, MethodDeclaration, MethodSignature, Node, ParameterDeclaration, PropertyAccessExpression, PropertyDeclaration, PropertySignature, QualifiedName, SetAccessorDeclaration, SymbolAccessibilityResult, TypeAliasDeclaration, TypeParameterDeclaration, VariableDeclaration } from "../../_namespaces/ts.js";
/** @internal */
...
/** @internal */
export declare function createGetIsolatedDeclarationErrors(resolver: EmitResolver): (node: Node) => DiagnosticWithLocation;
