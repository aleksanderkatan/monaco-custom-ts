import { CancellationToken, CompilerOptions, CustomTransformers, EmitOutput, HostForComputeHash, Path, Program, ResolutionMode, SourceFile } from "./_namespaces/ts.js";
/** @internal */
...
/** @internal */
export declare enum SignatureInfo {
    ComputedDts = 0,
