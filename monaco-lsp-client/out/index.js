...
//#region node_modules/@hediet/json-rpc/dist/JsonRpcTypes.js
...
//#endregion
//#region node_modules/@hediet/json-rpc/dist/common.js
...
//#endregion
//#region node_modules/@hediet/json-rpc/dist/MessageTransport.js
/**
* Base class for implementing a MessageStream.
* Provides an unreadMessage queue.
*/
var BaseMessageTransport = class BaseMessageTransport {
	static id = 0;
...
//#endregion
//#region node_modules/@hediet/json-rpc/dist/Channel.js
/**
...
var Channel = class Channel {
	...
	mapContext(map) {
		return new Channel((listener) => this.connect(listener ? mapRequestHandlerContext(listener, map) : void 0));
	}
};
...
//#endregion
//#region node_modules/@hediet/json-rpc/dist/StreamBasedChannel.js
/**
* Implements a channel through a stream and an optional request handler to handle incoming requests.
*/
var StreamBasedChannel = class StreamBasedChannel {
	_stream;
	_listener;
	_logger;
	/**
...
//#endregion
//#region node_modules/@hediet/json-rpc/dist/schema.js
var Serializers;
...
//#endregion
//#region node_modules/@hediet/json-rpc/dist/typedChannel/TypedChannel.js
...
*/
var TypedChannel = class TypedChannel extends TypedChannelBase {
	channelCtor;
	static fromTransport(stream, options = {}) {
		return new TypedChannel(StreamBasedChannel.createChannel(stream, options.logger), options);
	}
...
*/
var RequestHandlingError = class RequestHandlingError extends Error {
	data;
	code;
...
*/
var NotificationType = class NotificationType {
	method;
	paramsSerializer;
	kind = "notification";
...
//#endregion
//#region node_modules/@hediet/json-rpc/dist/typedChannel/TypedChannelContracts.js
...
*/
var ErrorWrapper = class ErrorWrapper {
	error;
...
//#endregion
//#region src/adapters/ITextModelBridge.ts
...
//#endregion
//#region src/adapters/languageFeatures/common.ts
const lspCodeActionKindToMonacoCodeActionKind = new Map([
...
const monacoCodeActionTriggerTypeToLspCodeActionTriggerKind = new Map([[monaco.languages.CodeActionTriggerType.Invoke, CodeActionTriggerKind.Invoked], [monaco.languages.CodeActionTriggerType.Auto, CodeActionTriggerKind.Automatic]]);
...
const lspCompletionItemKindToMonacoCompletionItemKind = new Map([
...
const lspCompletionItemTagToMonacoCompletionItemTag = new Map([[CompletionItemTag.Deprecated, monaco.languages.CompletionItemTag.Deprecated]]);
function toMonacoCompletionItemTag(tag) {
	return lspCompletionItemTagToMonacoCompletionItemTag.get(tag);
}
const monacoCompletionTriggerKindToLspCompletionTriggerKind = new Map([
...
const lspInsertTextFormatToMonacoInsertTextRules = new Map([[InsertTextFormat.Snippet, monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet]]);
function toMonacoInsertTextRules(format) {
	if (!format) return;
	return lspInsertTextFormatToMonacoInsertTextRules.get(format);
}
const lspSymbolKindToMonacoSymbolKind = new Map([
...
const lspSymbolTagToMonacoSymbolTag = new Map([[SymbolTag.Deprecated, monaco.languages.SymbolTag.Deprecated]]);
function toMonacoSymbolTag(tag) {
	return lspSymbolTagToMonacoSymbolTag.get(tag);
}
const lspDocumentHighlightKindToMonacoDocumentHighlightKind = new Map([
...
function toMonacoDocumentHighlightKind(kind) {
	if (!kind) return monaco.languages.DocumentHighlightKind.Text;
	return lspDocumentHighlightKindToMonacoDocumentHighlightKind.get(kind) ?? monaco.languages.DocumentHighlightKind.Text;
}
const lspFoldingRangeKindToMonacoFoldingRangeKind = new Map([
...
const monacoMarkerSeverityToLspDiagnosticSeverity = new Map([
...
const lspDiagnosticSeverityToMonacoMarkerSeverity = new Map([
...
function toMonacoDiagnosticSeverity(severity) {
	if (!severity) return monaco.MarkerSeverity.Error;
	return lspDiagnosticSeverityToMonacoMarkerSeverity.get(severity) ?? monaco.MarkerSeverity.Error;
}
const lspDiagnosticTagToMonacoMarkerTag = new Map([[DiagnosticTag.Unnecessary, monaco.MarkerTag.Unnecessary], [DiagnosticTag.Deprecated, monaco.MarkerTag.Deprecated]]);
function toMonacoDiagnosticTag(tag) {
	return lspDiagnosticTagToMonacoMarkerTag.get(tag);
}
const monacoSignatureHelpTriggerKindToLspSignatureHelpTriggerKind = new Map([
...
const lspInlayHintKindToMonacoInlayHintKind = new Map([[InlayHintKind.Type, monaco.languages.InlayHintKind.Type], [InlayHintKind.Parameter, monaco.languages.InlayHintKind.Parameter]]);
function toMonacoInlayHintKind(kind) {
	if (!kind) return monaco.languages.InlayHintKind.Type;
...
//#endregion
//#region src/adapters/languageFeatures/LspCompletionFeature.ts
var LspCompletionFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentCompletion, true, (capability) => {
			return monaco.languages.registerCompletionItemProvider(toMonacoLanguageSelector(capability.documentSelector), new LspCompletionProvider(this._connection, capability));
		}));
	}
};
...
function convertLspToMonacoCompletionItem(lspItem, bridge, translated, model, position) {
	...
	if (!range) range = monaco.Range.fromPositions(position, position);
	const item = {
		label: lspItem.label,
...
//#endregion
//#region src/adapters/languageFeatures/LspHoverFeature.ts
var LspHoverFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentHover, true, (capability) => {
			return monaco.languages.registerHoverProvider(toMonacoLanguageSelector(capability.documentSelector), new LspHoverProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspSignatureHelpFeature.ts
var LspSignatureHelpFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentSignatureHelp, true, (capability) => {
			return monaco.languages.registerSignatureHelpProvider(toMonacoLanguageSelector(capability.documentSelector), new LspSignatureHelpProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspDefinitionFeature.ts
var LspDefinitionFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDefinition, true, (capability) => {
			return monaco.languages.registerDefinitionProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDefinitionProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspDeclarationFeature.ts
var LspDeclarationFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDeclaration, true, (capability) => {
			return monaco.languages.registerDeclarationProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDeclarationProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspTypeDefinitionFeature.ts
var LspTypeDefinitionFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentTypeDefinition, true, (capability) => {
			return monaco.languages.registerTypeDefinitionProvider(toMonacoLanguageSelector(capability.documentSelector), new LspTypeDefinitionProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspImplementationFeature.ts
var LspImplementationFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentImplementation, true, (capability) => {
			return monaco.languages.registerImplementationProvider(toMonacoLanguageSelector(capability.documentSelector), new LspImplementationProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspReferencesFeature.ts
var LspReferencesFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentReferences, true, (capability) => {
			return monaco.languages.registerReferenceProvider(toMonacoLanguageSelector(capability.documentSelector), new LspReferenceProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspDocumentHighlightFeature.ts
var LspDocumentHighlightFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDocumentHighlight, true, (capability) => {
			return monaco.languages.registerDocumentHighlightProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDocumentHighlightProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspDocumentSymbolFeature.ts
var LspDocumentSymbolFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDocumentSymbol, true, (capability) => {
			return monaco.languages.registerDocumentSymbolProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDocumentSymbolProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspRenameFeature.ts
var LspRenameFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentRename, true, (capability) => {
			return monaco.languages.registerRenameProvider(toMonacoLanguageSelector(capability.documentSelector), new LspRenameProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspCodeActionFeature.ts
var LspCodeActionFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentCodeAction, true, (capability) => {
			return monaco.languages.registerCodeActionProvider(toMonacoLanguageSelector(capability.documentSelector), new LspCodeActionProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspCodeLensFeature.ts
var LspCodeLensFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentCodeLens, true, (capability) => {
			return monaco.languages.registerCodeLensProvider(toMonacoLanguageSelector(capability.documentSelector), new LspCodeLensProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspDocumentLinkFeature.ts
var LspDocumentLinkFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDocumentLink, true, (capability) => {
			return monaco.languages.registerLinkProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDocumentLinkProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspFormattingFeature.ts
var LspFormattingFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentFormatting, true, (capability) => {
			return monaco.languages.registerDocumentFormattingEditProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDocumentFormattingProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspRangeFormattingFeature.ts
var LspRangeFormattingFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentRangeFormatting, true, (capability) => {
			return monaco.languages.registerDocumentRangeFormattingEditProvider(toMonacoLanguageSelector(capability.documentSelector), new LspDocumentRangeFormattingProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspOnTypeFormattingFeature.ts
var LspOnTypeFormattingFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentOnTypeFormatting, true, (capability) => {
			return monaco.languages.registerOnTypeFormattingEditProvider(toMonacoLanguageSelector(capability.documentSelector), new LspOnTypeFormattingProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspFoldingRangeFeature.ts
var LspFoldingRangeFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentFoldingRange, true, (capability) => {
			return monaco.languages.registerFoldingRangeProvider(toMonacoLanguageSelector(capability.documentSelector), new LspFoldingRangeProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspSelectionRangeFeature.ts
var LspSelectionRangeFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentSelectionRange, true, (capability) => {
			return monaco.languages.registerSelectionRangeProvider(toMonacoLanguageSelector(capability.documentSelector), new LspSelectionRangeProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspInlayHintsFeature.ts
var LspInlayHintsFeature = class extends Disposable {
	...
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentInlayHint, true, (capability) => {
			...
			const disposable = monaco.languages.registerInlayHintsProvider(toMonacoLanguageSelector(capability.documentSelector), provider);
			return { dispose: () => {
...
var LspInlayHintsProvider = class {
	_onDidChangeInlayHints = new monaco.Emitter();
...
function toLspInlayHintLabel(label) {
	...
	return label.map((part) => {
		...
		if (part.location) monacoLabelPart.location = {
			...
			range: new monaco.Range(part.location.range.start.line + 1, part.location.range.start.character + 1, part.location.range.end.line + 1, part.location.range.end.character + 1)
		};
...
//#endregion
//#region src/adapters/languageFeatures/LspSemanticTokensFeature.ts
var LspSemanticTokensFeature = class extends Disposable {
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentSemanticTokensFull, true, (capability) => {
			return monaco.languages.registerDocumentSemanticTokensProvider(toMonacoLanguageSelector(capability.documentSelector), new LspSemanticTokensProvider(this._connection, capability));
		}));
	}
};
...
//#endregion
//#region src/adapters/languageFeatures/LspDiagnosticsFeature.ts
var LspDiagnosticsFeature = class extends Disposable {
	...
	constructor(_connection) {
		...
		this._register(this._connection.capabilities.registerCapabilityHandler(capabilities.textDocumentDiagnostic, true, (capability) => {
			...
			for (const model of monaco.editor.getModels()) this._addPullDiagnosticProvider(model, capability, disposables);
...
//#endregion
//#region src/adapters/LspConnection.ts
...
//#endregion
//#region src/adapters/LspCapabilitiesRegistry.ts
...
var DynamicFromStaticOptions = class DynamicFromStaticOptions {
...
//#endregion
//#region src/adapters/TextDocumentSynchronizer.ts
var TextDocumentSynchronizer = class extends Disposable {
	...
	constructor(_server, _capabilities) {
		...
		this._register(_capabilities.registerCapabilityHandler(capabilities.textDocumentDidChange, true, (e) => {
			...
			for (const m of monaco.editor.getModels()) this._getOrCreateManagedModel(m);
			return { dispose: () => {} };
		}));
	}
	...
	translateBack(textDocument, position) {
		...
		return {
			textModel,
			position: new monaco.Position(position.line + 1, position.character + 1)
		};
	}
...
//#endregion
//#region src/adapters/LspClient.ts
...
//#endregion
//#region node_modules/@hediet/json-rpc-websocket/dist/index.js
/**
...
*/
var WebSocketTransport = class WebSocketTransport extends BaseMessageTransport {
	socket;
	static connectTo(options) {
		...
		return new Promise((res, rej) => {
			...
			ws$1.onopen = () => {
				res(new WebSocketTransport(ws$1));
			};
		});
	}
...
//#endregion
//#region node_modules/@hediet/json-rpc-browser/dist/WindowLikeStream.js
...
//#endregion
//#region node_modules/@hediet/json-rpc-browser/dist/worker.js
/**
...
//#endregion
//#region node_modules/@hediet/json-rpc-browser/dist/iframe.js
/**
* Gets a stream that uses `worker.postMessage` to write
* and `worker.addEventListener` to read messages.
*/
